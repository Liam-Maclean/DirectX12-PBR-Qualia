	...
	const OutputPatch<HS_CONTROL_POINT_OUTPUT, NUM_CONTROL_POINTS> patch)
{
	...
	vertexPosition = domain.x * patch[0].vPosition.xyz + domain.y * patch[1].vPosition.xyz + domain.z * patch[2].vPosition.xyz;
	Output.vPosition = mul(float4(vertexPosition, 1.0f), mvpMat);
