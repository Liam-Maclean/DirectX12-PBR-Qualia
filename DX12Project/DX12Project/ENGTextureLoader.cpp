...
int ENGTextureLoader::LoadImageDataFromFile(BYTE** imageData, D3D12_RESOURCE_DESC& resourceDescription, LPCWSTR filename, int& bytesPerRow)
{
	HRESULT hr;
	...
	//if the format of the image is not supported DXGI format, try to convert it 
...
//TO DO: MOVE THIS TO A UTILITY CLASS
DXGI_FORMAT ENGTextureLoader::GetDXGIFormatFromWICFormat(WICPixelFormatGUID& wicFormatGUID)
{
...
//TO DO: MOVE THIS TO A UTILITY CLASS
WICPixelFormatGUID ENGTextureLoader::GetConvertToWICFormat(WICPixelFormatGUID& wicFormatGUID)
{
...
//TO DO: MOVE THIS TO A UTILITY CLASS
int ENGTextureLoader::GetDXGIFormatBitsPerPixel(DXGI_FORMAT& dxgiFormat)
{
